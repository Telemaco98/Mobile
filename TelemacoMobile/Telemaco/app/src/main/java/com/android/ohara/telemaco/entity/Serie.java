...
import com.android.ohara.telemaco.entity.enums.Classification;
...
public class Serie {
    ...
    public Serie(String name, int year, String status, String creator, String classification, String genre, String synopsis, String image) {
    	this.name = name;
    	this.year = year;
    	this.status = status;
    	...
    	this.classification = stringToClassif(classification);
    	this.image = image; 
    	this.seasons = null;
    	this.ratings = null;
    }
    
    public Serie(int id, String name, int year, String status, String creator, String classification, String genre, String synopsis, String image, ArrayList<Season> seasons) {
    	this.id = id;
    	this.name = name;
    	this.year = year;
    	this.status = status;
